...
public class ACharacter extends AObject{
    ...
    public ACharacter(int graphicFileIndex) throws IOException {
        super(graphicFileIndex);
        HP=100;
        density = true;
        jury = null;
        fireballCooldown = 2;
    ...
    public void StepIntoDirection(int x, int y)
    {
        ...
        if(physics.IsMovePossible(positionX + x,positionY+y))
        {
            ...
            moveRemainingCooldown = (double)1/moveSpeed;
        }
        return;
    }
